...
```
给金蝶苍穹平台做一个产品 Landing Page 原型
做个金蝶云发布会幻灯片（5 页）
给金蝶记账 App 做 iOS 原型，展示核心功能流程
推荐几个设计风格方向，做一个金蝶 SaaS 产品落地页
```
...
| 风格 | 流派 | 视觉气质 |
|------|------|---------|
| **Pentagram** | 信息建筑派 | 黑白克制、瑞士网格、强字体层级 |
| **Build** | 极简主义派 | 奢侈品级留白(70%+)、微妙字重 |
| **Takram** | 东方哲学派 | 柔和科技感、自然色、图表如艺术 |
